...
<head>
    ...
    <link rel="preload" href="<?= get_template_directory_uri() . '/dist/fonts/rhicons.woff2?3oibrk'; ?>" as="font"
...
<?php if (!is_cart()) : ?>
    <div class="mini--cart__wrap" data-cart-close="true">
        <div class="mini--cart">
