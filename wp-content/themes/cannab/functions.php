...
function cannab_scripts()
{
    ...
    wp_enqueue_script('mini-cart-update', get_template_directory_uri() . '/js/mini-cart-update.js', array('jquery'), _S_VERSION, true);
    wp_localize_script('mini-cart-update', 'min_cart_qty_ajax', array('ajax_url' => admin_url('admin-ajax.php')));
    wp_enqueue_script('mini-cart-update');
...
add_action('wp_ajax_mini_cart_update', 'ajax_mini_cart_update');
add_action('wp_ajax_nopriv_mini_cart_update', 'ajax_mini_cart_update');

add_filter('woocommerce_single_product_zoom_enabled', '__return_false');


add_filter('woocommerce_checkout_fields', 'cannab_change_autofocus_checkout_field');

function cannab_change_autofocus_checkout_field($fields)
{
